...
class MyTopo( Topo ):
    ...
    def build( self, **_opts ):
        ...
        defaultIP1 = '10.10.5.1/24' #IP pro roteador 1
        defaultIP2 = '10.10.5.2/24' #IP pro roteador 2
        #s1 = self.addSwitch( 's1', cls=LinuxBridge)

        router1 = self.addNode( 'r1', cls=Router, ip=defaultIP1)
        router2 = self.addNode( 'r2', cls=Router, ip=defaultIP2)

        client1 = self.addHost( 'h1', ip='10.10.1.1/24', defaultRoute='via 10.10.1.2' )
        client2 = self.addHost( 'h2', ip='10.10.2.1/24', defaultRoute='via 10.10.2.2' )
        ...
        self.addLink(server3, router2, intfName2='r2-eth4', params2={ 'ip': '10.10.8.1/24'} )
        self.addLink(server4, router2, intfName2='r2-eth3', params2={ 'ip': '10.10.9.1/24'} )
